...
def _start():
    ...
    '''
    global parser, args, config, r, response, patch, name, monitor, endsample, H, blocksize, A, ft_output, block, begsample
...
def _loop_once():
    ...
    '''
    global parser, args, config, r, response, patch, monitor, endsample, H, blocksize, A, ft_output, block, begsample
